  ...
  require_once '../models/User.php';
	...
	class UserService implements UserInterface {
		...
		public function registrarUsuario($usuario) {
			...
			$sql_insertar = "INSERT INTO usuarios (nombre, apaterno, amaterno, direccion, telefono, correo, usuario, password) VALUES (null, '$nombre', '$apaterno', '$amaterno', '$direccion', '$telefono', '$correo', '$username', '$password')";
		...
		public function obtenerTodosUsuariosPorId($id) {
		...
		public function obtenerTodosUsuariosPorCorreo($correo) {
